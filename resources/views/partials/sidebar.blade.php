<div class="sidebar-wrapper active">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="logo">
                <a href="{{ route('admin.dashboard') }}">
                    <span class="fw-bold fs-5 text-primary">⚡ Nexora Digital</span>
                </a>
            </div>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-title">Katalog</li>
            ...
            <li class="sidebar-item {{ request()->routeIs('admin.qris.*') ? 'active' : '' }}">
                <a href="{{ route('admin.qris.index') }}" class="sidebar-link">
                    <i class="bi bi-qr-code"></i>
                    <span>QRIS</span>
                </a>
            </li>

            <li class="sidebar-title">Telegram</li>

            <li class="sidebar-item {{ request()->routeIs('admin.telegram-users.*') ? 'active' : '' }}">
                <a href="{{ route('admin.telegram-users.index') }}" class="sidebar-link">
                    <i class="bi bi-telegram"></i>
                    <span>Telegram Users</span>
                </a>
            </li>

            <li class="sidebar-item {{ request()->routeIs('admin.broadcast.*') ? 'active' : '' }}">
                <a href="{{ route('admin.broadcast.index') }}" class="sidebar-link">
            ...
            <li class="sidebar-item {{ request()->routeIs('admin.activity-logs.*') ? 'active' : '' }}">
